...
<?php include('top.php');						?>
	...
	<div id="wrapper-header-inner" style="height:0px">
    <div>
...
<iframe src="searchbar.php" width=100% name="top"></iframe>
<iframe src="category_left.php" name="left" width=22% height=950 ></iframe>
<?php if(isset($_REQUEST['id']))
echo "<iframe src='course_category.php?id=".$_REQUEST['id']."'  name='right' height=850 width=77%></iframe>";
else if(isset($_REQUEST['id1']))
echo "<iframe src='course_category.php?id=".$_REQUEST['id']."&&id1=".$_REQUEST['id1']."'  name='right' height=850 width=77%></iframe>";
else
echo "<iframe src='course_category.php'  name='right' height=850 width=77%></iframe>";
?>
