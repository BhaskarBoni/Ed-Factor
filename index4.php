...
include('db.php');
$q="update `fa_registration` set `code`='1' where  `code`='".$_REQUEST['id']."'";
echo $q;
if(mysql_query($q))
                        ...
                        <div id="login" class="animate form">
                            <form  action="reg.php" autocomplete="on" method=post> 
                                ...
                                <p> 
                                    ...
                                    <input id="username_login" name="username_login" required="required" type="text" placeholder="myusername or mymail@mail.com"/>
                                </p>
                                <p> 
                                    <label for="password" class="youpasswd" data-icon="p"> Your password </label>
                                    <input id="password_login" name="password_login" required="required" type="password" placeholder="eg. X8df!90EO" /> 
                                </p>
                                <p class="keeplogin"> 
									<input type="checkbox" name="loginkeeping_login" id="loginkeeping_login" value="loginkeeping" /> 
